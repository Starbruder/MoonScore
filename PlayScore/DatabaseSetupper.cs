...
public static class DatabaseSetupper
{
    // This got removed, because it was just for testing purposes, at the beginning dev of the app.
    // In case you want to use it, make public for example.
    private static async Task AddAllGamesToDatabase(GameService gameService, DatabaseManager databaseManager)
    {
        ...
        foreach (string date in additionalDateStrings)
        {
            try
            {
                var gameData = await gameService.GetGamesByReleaseDateAsync(date);
                ...
                await databaseManager.AddGamesToSpieleTableAsync(gameData);
